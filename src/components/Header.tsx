...
export default function Header() {
  return (
    <header className="relative">
      {/* Main Banner exactly matching the uploaded mockup */}
      <div
      ...
      >
        ...
        <div className="absolute top-4 right-6 flex space-x-2 z-30">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="w-10 h-10 bg-blue-600 rounded-full flex items-center justify-center transition-all duration-300 group hover:scale-110 hover:bg-blue-700"
          >
            <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="w-10 h-10 bg-red-600 rounded-full flex items-center justify-center transition-all duration-300 group hover:scale-110 hover:bg-red-700"
          >
            <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="w-10 h-10 bg-black rounded-full flex items-center justify-center transition-all duration-300 group hover:scale-110 hover:bg-gray-800"
          >
            <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
